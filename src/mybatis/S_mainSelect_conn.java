...
public class S_mainSelect_conn {

	static S_mainSelect_conn mainConn = new S_mainSelect_conn();
	// 아래 매소드에서 실제 명령문이 적혀이는 xml에서  받아온 값을 가지고 다른파일에 가지위해서 싱글톤형식으로 객체화
	public static S_mainSelect_conn instance() {
		return mainConn;
	}
