...
<form name="reserv_to_pay" action="hotel_pay_toss.jsp" method="post">
	...
	<div id="content">
	   ...
	   <div id="content_hotel_div">
	     ...
	     <img id="content_hotel_image"  src=""/>
	     </div>
	     <div id="content_hotel_name">
	     <h2 id="h_name_eng">Hotel_eng_name</h2>
	     <h4 >호텔 한국 이름</h4>
	     <h5>5 성급</h5>
	     <h5 >호텔 주소</h5>
	      <h5 >TEL : 호텔 번호</h5>
	      
	     <input type="hidden" name="h_name_eng" value="hotel_eng_name">
	    <input type="hidden" name="h_name_ko" value="hotel_kor_name">
        <input type="hidden" id="h_m_id_input" name="h_m_id" value="mem_id">
	   ...
	   <table id="content_date_info">
        ...
        <input type="hidden" id="h_indate" name="h_indate" value="2023-12-12">
	    <input type="hidden" id="h_outdate" name="h_outdate" value="2023-12-31">
           </tr>	   
	   	   <tr>
            <th>투숙객 </th>
            <th>투숙기간</th>
            ...
            <td >10 명</td>
            <td >20 박</td>
        <input type="hidden" id ="h_room_user" name="h_roompeo" value="10">
	    <input type="hidden" name="h_night_time" value="20">
           </tr>
           <tr>
            <th>객실 </th>
            <th></th>
	    ...
	    <div id="content_room_div">
	     ...
	     <img id="content_room_image" src=""/>
	     </div>
	     <div id="content_room_name">
	     <h3 name="h_roomtype">룸 타입 : 더블 베드</h3>
	     <input type="hidden" id="h_roomnum" name="h_roomnum" value="100">
      ...
      <div id="content_room_price_div">
        <table id="content_room_price_table">
 		   <tr>
            <td class="td_1">1박</td>
            <td class="td_2"> <h4 class="td_2_price">&#8361; 100,000</td>
           </tr>        
 		   <tr>

 		   	<tr>
            <td name="h_night_time"  class="td_1">29 박</td>
            <td class="td_2"> <h4 class="td_2_price">&#8361; 2,900,000</h4></td>
           </tr>        
 		   <tr>
            <td class="td_1">세금 및 수수료</td>
   
            <td class="td_2"> <h4 class="td_2_price"> &#8361; 세금</h4></td>
           </tr>            
 		   <tr>
   
            <td class="td_1">부가세</td>
            <td class="td_2"><h4 class="td_2_price">&#8361; 부가세%</h4></td>
 		   <tr>
    
            <td class="td_1">할인</td>
            <td class="td_2"> <h4 class="td_2_price">&#8361;할인%</h4></td>
           </tr>
           <tr>
           
            <td class="td_total">총 가격</td>
            <td class="td_totalpri"> <h3 class="td_2_price">&#8361; 총 가격 2,900,000</h3></td>
            <input type="hidden" id="h_total_price" name="total_price" value="2900000">
           </tr>            
        </table>
